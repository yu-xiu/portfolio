...
export const MLFramework = [
    ...
    { name: "Gymnasium", icon : Gymnasium, link: "https://gymnasium.farama.org/index.html"},
    { name: "Ray", icon: Ray, link: "https://docs.ray.io/en/latest/rllib/rllib-algorithms.html"},
...
export const CloudDevOps = [
    ...
    {name: "GoogleCloud", icon: Googlecloud, link: "https://cloud.google.com/"},
